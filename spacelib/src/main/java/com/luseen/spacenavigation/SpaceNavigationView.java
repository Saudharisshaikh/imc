...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int centreButtonSizeH = (int) getResources().getDimension(R.dimen.center_text_width);
    ...
    private int centerTextViewId = NOT_DEFINED;

    private int centreButtonColor = NOT_DEFINED;

    private int centreTextColor = NOT_DEFINED;
    ...
    private void initAndAddViewsToMainView() {
        ...
        rightContent.setLayoutDirection(LAYOUT_DIRECTION_LTR);
        leftContent.setLayoutDirection(LAYOUT_DIRECTION_LTR);
        ...
        if (centerTextViewId != NOT_DEFINED) {
            centerTextView.setId(centerTextViewId);
        }

        centerTextView.setText("\nAppointment");
        centerTextView.setText(centreText);
        centerTextView.setGravity(Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL);
        centerTextView.setTextSize(14);
        centerTextView.setPadding(5, 5, 5, 5);
//        centerTextView.setTextColor(centreTextColor);
        ...
        LayoutParams fabParams1 = new LayoutParams(centreButtonSizeH, centreButtonSizeH);
        fabParams1.addRule(RelativeLayout.CENTER_HORIZONTAL);
//        fabParams1.addRule(RelativeLayout.BELOW, centreButtonId);
        ...
        leftContentParams.setLayoutDirection(LAYOUT_DIRECTION_LTR);
        ...
        rightContentParams.setLayoutDirection(LAYOUT_DIRECTION_LTR);
        ...
        centreContent.addView(centerTextView, fabParams1);
    ...
    public void setCentreTextId(@IdRes int id) {
        this.centerTextViewId = id;
    }
    ...
    public void setCentreTextColor(@ColorInt int centreTextColor) {
    ...
    public void setCentreText(String centreButtonIcon) {
        this.centreText = centreButtonIcon;
        centerTextView.setText(centreText);
