...
import sa.med.imc.myimc.Records.adapter.OperativeOldAdapter;
...
public class OperativeReportOldFragment extends Fragment {
    ArrayList<OperativeReportOldModel.Data> dataArrayList=new ArrayList<>();
    ...
    OperativeOldAdapter operativeOldAdapter;

    public OperativeReportOldFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_operative_report_old, container, false);
    }
    ...
    private void initView() {
        ...
        operativeOldAdapter =new OperativeOldAdapter(getContext(),dataArrayList);

        GridLayoutManager gridLayoutManager=new GridLayoutManager(getContext(),1);
        rv_records.setLayoutManager(gridLayoutManager);
        rv_records.setAdapter(operativeOldAdapter);
    ...
    private void loadData() {
        new MyhttpMethod(getContext()).operativeOldReport(String.valueOf(pageNumber), new OperativeOldListner() {
            @Override
            public void onSuccess(OperativeReportOldModel operativeReportOldModel) {
                dataArrayList.addAll(operativeReportOldModel.data);
                tv_total.setText(operativeReportOldModel.total_items);
                operativeOldAdapter.notifyDataSetChanged();
                pageNumber++;
