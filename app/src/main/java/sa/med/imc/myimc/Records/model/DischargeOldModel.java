...
public class DischargeOldModel {
    ...
    public DischargeOldModel() {
    }

    public DischargeOldModel(String status, String message, ArrayList<Data> data, String total_items, String total_pages) {
        this.status = status;
